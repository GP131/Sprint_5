...
def test_navigate_to_constructor_to_personal_account_via_constructor_button(credentials, driver):
...
def test_navigate_to_constructor_to_personal_account_via_constructor_logo(credentials, driver):
    email = credentials["email"]
    password = credentials["password"]
